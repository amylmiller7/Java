 ...
 * Enums for olive colors, private variable accessible only in this class, constructor method that passes parameter.
...
public enum OliveColor {
    ...
    // Creates constructor method that matches the name and color of the enum list and accepts translated enum.
    OliveColor(String name, long color) {
        //  this.instance variable = argument name/color. Assigns instance variables to this method's arguments.
        this.name = name;
        this.color = color;
    }
